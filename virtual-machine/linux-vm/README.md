...
| Name | Description |
|------|-------------|
| <a name="output_id"></a> [id](#output\_id) | ID of the Linux Virtual Machine. |
| <a name="output_name"></a> [name](#output\_name) | Name of the Linux Virtual Machine. |
| <a name="output_object"></a> [object](#output\_object) | Object of the Linux Virtual Machine. |
